...
const ProductGrid = (props: IProductGrid) => {
    ...
    return (
      ...
      <Dialog as="div" className="relative z-10" initialFocus={cancelButtonRef} onClose={setProductOpen}>
        <Transition.Child
          as={Fragment}
                        ...
                        {category?.products.map((product) => (
                            ...
                            >
                                ...
                                <div className="mt-6">
                                    ...
                                    <button onClick={(title) => openProductModal(product.title)}  > Click Me{product.title}</button>
